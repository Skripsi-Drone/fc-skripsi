...
//     // ===== Stabilize (angle→rate) P-only =====
//     roll_rate_sp  = constrain(er * gain.stab_roll_P,  -gain.max_rate_r,  gain.max_rate_r);
//     pitch_rate_sp = constrain(ep * gain.stab_pitch_P, -gain.max_rate_p,  gain.max_rate_p);
